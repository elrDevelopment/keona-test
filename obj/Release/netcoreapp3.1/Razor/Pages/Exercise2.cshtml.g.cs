#pragma checksum "C:\Users\elrde\Documents\projects\test-deleteme\WebApplication\WebApplication\Pages\Exercise2.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "29de9fe1172c9a5b28721b4efe35881d49566c67"
// <auto-generated/>
...
#nullable disable
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"29de9fe1172c9a5b28721b4efe35881d49566c67", @"/Pages/Exercise2.cshtml")]
    ...
    <div class=""mt-2"">
        <div class=""max-w-screen-xl mx-auto py-6 px-4 sm:px-6 lg:py-6 lg:px-8"">
          <div class=""mt-6 border-t-2 border-gray-200 pt-6"">
            ...
            WriteLiteral(@"t / Continuous Integration / Automated Tests?
                </dt>
                <dd class=""mt-2 md:mt-0 md:col-span-7"">
                  <p class=""text-base leading-6 text-gray-500"">
                    Using a Dev Ops platform I would ensure that there are pipelines in place for CI/CD/AT. At the core of high availability is the aspect that the code works. Continuous testing via build and integration pipelines is a trusted way to do this. 
              ...
              <div class=""mt-8 border-t border-gray-200 pt-6 md:grid md:grid-cols-12 md:gap-8"">
                ...
                <dd class=""mt-2 md:mt-0 md:col-span-7"">
                  <p class=""text-base leading-6 text-gray");
            WriteLiteral(@"-500"">
                    The other tool or mechanism that makes this process fairly easy is some version of an API Gateway. This tool or service allows one point of entry to an environment.
              ...
              <div class=""mt-8 border-t border-gray-200 pt-6 md:grid md:grid-cols-12 md:gap-8"">
                ...
                <dd class=""mt-2 md:mt-0 md:col-span-7"">
                  <p class=""text-base leading-6 text-gray-500"">
                    An update would include ensuring the API gateway is pointed at the correct");
            WriteLiteral(@" server. For the server or system that is offline (Prod B). Push the code to the web service or database via a release pipeline.
                    Using the API Gateway switch the system to the alternate production environment that was just updated. You are now running with updated code. Now update Prod A system using an alternate release pipeline. One could
                    swith back the API Gateway to the Prod A system if maintenance and system config required. Technically there should be any downtime in this scenario.
                  </p>
                </dd>
              </div>
...
<div id=""output"" class=""col-span-1 mx-5 bg-white overflow-hidden shadow rounded-lg mt-10"">
  ...
  <div class=""flex justify-center mt-5"">
        <iframe src=""https://netorgft4560686-my.sharepoint.com/personal/eric");
            WriteLiteral(@"k_r10dev_com/_layouts/15/Doc.aspx?sourcedoc={bb27efff-4fba-4e90-a49a-31c2242b8c60}&amp;action=embedview"" 
