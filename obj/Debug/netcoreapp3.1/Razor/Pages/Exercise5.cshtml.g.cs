#pragma checksum "C:\Users\elrde\Documents\projects\test-deleteme\WebApplication\WebApplication\Pages\Exercise5.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5410569c551ff59be298a494f63faa4e197d0d36"
// <auto-generated/>
...
#nullable disable
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5410569c551ff59be298a494f63faa4e197d0d36", @"/Pages/Exercise5.cshtml")]
...
<div id=""solution"" class="" mx-0 md:mx-5 col-span-2 md:col-span-1  bg-white overflow-hidden shadow rounded-lg mt-10 max-w-5xl mx-auto"">
  <div class=""px-4 py-5 sm:p-6"">
  ...
  ");
            WriteLiteral(@"                Client Side
                </dt>
                <dd class=""mt-2 md:mt-0 md:col-span-7"">
                  <p class=""text-base leading-6 text-gray-500"">
                    Depending on the project and use case. I usually use either Razor Pages / MVC or for a client first app I lean towards Angular frontend. I don't really have a specific reason here to go with Angular. 
                    It is just something that I started using and have grown to like it.
     ...
     ");
            WriteLiteral(@"               <li>.Net Core Web Api</li>
                    <li>Entity Framework ORM</li>
                    <li>Fluent Validation</li>
                    <li>Auto Mapper for object to DTO mapping</li>
                  </ul>
                </dd>
              </div>
              <div class=""mt-8 border-t border-gray-200 pt-6 md:grid md:grid-cols-12 md:gap-8"">
                ...
                <dd class=""mt-2 md:mt-0 md:col-span-7"">
                  <p class=""text-base leading-6 text-gray-500"">
                    ...
                    SQL is well supported in Azure and AWS RDS so covera");
            WriteLiteral(@"ge is good and well documented in cloud providers
                  </p>
                </dd>
              </div>
           <div class=""mt-8 border-t border-gray-200 pt-6 md:grid md:grid-cols-12 md:gap-8"">
          ...
          <div class=""mt-8 border-t border-gray-200 pt-6 md:grid md:grid-cols-12 md:gap-8"">
           ...
           <dd class=""mt-2 md:mt-0 md:col-span-7"">
             <p class=""text-base leading-6 text-gray-500"">
             I would most like use Azure DevOps pipelines for all ");
            WriteLiteral(@"CI/CD/AT. It integrates well with on prem, and cloud providers to deploy solutions as need to multiple tenants.
             </p>
           </dd>
         </div>
            </dl>
